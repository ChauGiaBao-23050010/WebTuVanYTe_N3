...
document.addEventListener('DOMContentLoaded', () => {
    // --- DỮ LIỆU CHO GÓI DỊCH VỤ (Ví dụ: Gói Khám Sức Khỏe Tổng Quát) ---
    // Trong thực tế, bạn có thể có nhiều đối tượng gói, và trang này có thể hiển thị 1 gói cụ thể
    // dựa trên URL param, hoặc đây là trang chung cho 1 gói.
    const servicePackageData = {
        ...
        shortDescription: {
            en: "Comprehensive examination, early detection of health risks.",
            vi: "Kiểm tra toàn diện, phát hiện sớm rủi ro sức khỏe."
        },
        details: {
